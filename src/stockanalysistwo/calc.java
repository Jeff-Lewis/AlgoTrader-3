...
public class calc {
    ...
    {        
        File directory = new File("/home/garth/Desktop/stock/stock_pre_2000");                            //directory of program files
		...
		try {
			int lineNumber = findNumDays(fileName);
                        ...
                        double R2=0.0;                 
                        int period =10;
                        double difPercent=1.5;    
                        double TradePercent=0.04; 
                        double minSRDifin=0.1;//algorithm parameters
                        ...
                        for(int i=0;i<lineNumber-period;i++){
                            ...
                            if(currentSRDif>minSRDif){
                                ...
                                //buy or sell a percentage of the money or shares
