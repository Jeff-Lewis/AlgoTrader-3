		...
		try {
			int lineNumber = findNumDays(fileName);
                        ...
                        {   
                            ...
                            if(currentResistValue-currentSupportValue>supportResistDif){
                                supportResistDif=currentResistValue-currentSupportValue;
                                bestStartDay=i;
                            }
                        }
                        System.out.println("Best supportResistDif = "+supportResistDif);
                        System.out.println("Best supportResistDif as a percentage = "+supportResistDif/((getValueFromCurve(bestStartDay,supportCurve)+getValueFromCurve(bestStartDay,resistCurve))/2)*100);
                        System.out.println("Best Day = "+bestStartDay);
                        System.out.println("is it below sup?"+isBelowSup(2,supportCurve,2));
