...
public class Sixth {
        ...
        for(int i = 2;i<=15;i++){
            for(int j=2;j<=10;j++){
                for(int k=2;k<=10;k++){
                    ...
                    int period=j;
                    double difPercent=k;
                    double answer=OptimiseParameters(curvePoints,period,difPercent);
    ...
    //special method :p
    public static double OptimiseParameters(int curvePointsin,int periodin,double difPercentin ) 
    {        
